...
def click_with_track(note_frames:np.ndarray, sample_rate:int, HOP_LENGTH:int, raw_track:np.ndarray, file_path:str):
    ...
    sf.write(file_path, y_with_clicks, sample_rate)